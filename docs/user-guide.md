...
Verified Client IP determines the true IP address of visitors to your
...
1. Copy `verified-client-ip.php` and the `src/` directory to
   `wp-content/mu-plugins/verified-client-ip/`.
2. Create `wp-content/mu-plugins/verified-client-ip-loader.php`:

```php
<?php
require_once ABSPATH . 'wp-content/mu-plugins/verified-client-ip/verified-client-ip.php';
```
