...
This directory contains proxy configurations and the Docker Compose file used to set up a local testing environment for the Gryphon Verified Client IP plugin.
...
You can use the development container to build the package, which will publish to `build/gryphon-verified-client-ip/`.
