...
final class AdminPageTest extends TestCase
{
    ...
    public function testParseFormInputBasicSettings(): void
    {
        ...
        $result = AdminPage::parseFormInput($post);
    ...
    public function testParseAndValidateRoundTrip(): void
    {
        ...
        $parsed = AdminPage::parseFormInput($post);
        ...
        $this->assertTrue($result['settings']->processProto);
        $this->assertTrue($result['settings']->processHost);
