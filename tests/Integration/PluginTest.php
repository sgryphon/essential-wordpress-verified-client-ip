...
final class PluginTest extends TestCase
{
    ...
    public function testVcipIpResolvedActionFired(): void
    {
        ...
        $actionArgs = $GLOBALS['_vcip_test_actions']['vcip_ip_resolved'][0];
        $this->assertSame('203.0.113.50', $actionArgs[0]); // new IP
        $this->assertSame('10.0.0.1', $actionArgs[1]);     // original IP
        $this->assertIsArray($actionArgs[2]);               // step trace
    }
