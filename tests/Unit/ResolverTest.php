...
final class ResolverTest extends TestCase
{
    ...
    public function testNoOpWhenRemoteAddrNotTrustedProxy(): void
    {
        ...
        $result = $this->resolver->resolve($server, $this->defaultSchemes);

        $this->assertFalse($result->changed);
        $this->assertSame('203.0.113.50', $result->resolvedIp);
        $this->assertSame('203.0.113.50', $result->originalIp);
    ...
    public function testNoOpWhenHeaderNotPresent(): void
    {
        ...
        $this->assertFalse($result->changed);
        $this->assertSame('10.0.0.1', $result->resolvedIp);
    }
    ...
    public function testSingleHopXff(): void
    {
        ...
        $result = $this->resolver->resolve($server, $this->defaultSchemes, 1);

        $this->assertTrue($result->changed);
        $this->assertSame('203.0.113.50', $result->resolvedIp);
        $this->assertSame('10.0.0.1', $result->originalIp);
    }
    ...
    public function testSingleHopForwardedHeader(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('203.0.113.50', $result->resolvedIp);
        $this->assertSame('192.168.1.1', $result->originalIp);
    }
    ...
    public function testMultiHopTwoProxies(): void
    {
        ...
        $result = $this->resolver->resolve($server, $this->defaultSchemes, 2);
    ...
    public function testSchemePriorityFirstMatchWins(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('1.1.1.1', $result->resolvedIp);
    }
    ...
    public function testMalformedValueBecomesVerifiedIp(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('unknown', $result->resolvedIp);
    }
    ...
    public function testHiddenTokenBecomesVerifiedIp(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('_hidden', $result->resolvedIp);
    }
    ...
    public function testHostnameBecomesVerifiedIp(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('example.com', $result->resolvedIp);
    }
    ...
    public function testGarbageStringBecomesVerifiedIp(): void
    {
        ...
        $this->assertSame('<script>alert(1)</script>', $result->resolvedIp);
    }
    ...
    public function testIpv6RemoteAddrWithUlaProxy(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('2001:db8::100', $result->resolvedIp);
    }
    ...
    public function testAllTrustedUsesOutermost(): void
    {
        ...
        $result = $this->resolver->resolve($server, $this->defaultSchemes, 3);

        $this->assertTrue($result->changed);
        $this->assertSame('10.0.0.3', $result->resolvedIp);
    }
    ...
    public function testForwardedHeaderWithQuotedIpv6(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('2001:db8::1', $result->resolvedIp);
    }
    ...
    public function testDisabledSchemeSkipped(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('2.2.2.2', $result->resolvedIp);
    }
    ...
    public function testPortStrippedFromForwardedAddress(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('192.0.2.1', $result->resolvedIp);
    }

    // ---------------------------------------------------------------
    // Scheme toArray / fromArray
    // ---------------------------------------------------------------
    ...
    public function testForwardLimitTwoPublicRemoteAddr(): void
    {
        ...
        $this->assertFalse($result->changed);
        $this->assertSame('8.8.8.8', $result->resolvedIp);
    }
    ...
    public function testForwardLimitTwoTwoProxiesTrustedNext(): void
    {
        ...
        $this->assertTrue($result->changed);
        $this->assertSame('10.5.6.7', $result->resolvedIp);
    }
    ...
    public function testForwardLimitDiagnosticStepShowsReason(): void
    {
        ...
        $this->assertNotNull($limitStep, 'Expected a step mentioning "Forward limit"');
        $this->assertStringContainsString('10.5.6.7', $limitStep->action);
    }
    ...
    public function testForwardLimitDiagnosticStepShowsUntrusted(): void
    {
        ...
        $this->assertStringContainsString('not a trusted proxy', $lastStep->action);
    }
}
